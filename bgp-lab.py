...
class OSPFLab(Topo):
	...
	def build(self, *args, **kwargs):
		...
		#  R1 subnet
		C1_1 = self.addHost('C1_1', ip="172.16.0.2/24", defaultRoute="via 172.16.0.1")
		C1_2 = self.addHost('C1_2', ip="172.16.1.2/24", defaultRoute="via 172.16.1.1")
	...
	#region
		...
		# R2 Subnet
		C2_1 = self.addHost('C2_1', ip="172.17.0.2/24", defaultRoute="via 172.17.0.1")
		C2_2 = self.addHost('C2_2', ip="172.17.1.2/24", defaultRoute="via 172.17.1.1")
...
# R3 Subnet
		C3_1 = self.addHost('C3_1', ip="172.18.0.2/24", defaultRoute="via 172.18.0.1")
		C3_2 = self.addHost('C3_2', ip="172.18.1.2/24", defaultRoute="via 172.18.1.1")
